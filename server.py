#!/usr/bin/env python3
"""Root entry point: delegates to the BuildUrgent AI server in ``backend/server.py``.
...
from backend.server import BuildUrgentHandler, build_server, main  # noqa: E402,F401
